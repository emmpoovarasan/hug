...
public class SignInPageDE extends TestCase {
  ...
  public void testSignInPage() throws Exception {
    ...
    try {
      assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Anmelden[\\s\\S]*$"));
      lang="DE";
      System.out.println("Test present in German "+lang);
